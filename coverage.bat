...
%REPORTGENERATOR_EXE% -reports:%RESULTFILEPATH% -targetdir:.\CoverageReports "-assemblyfilters:+Helper;+%PROJECTNAME%;+%TESTPROJECTNAME%" "-filefilters:-*.g.cs;-*.Designer.cs;-*Microsoft.NET.Test.Sdk.Program.cs"
goto end
