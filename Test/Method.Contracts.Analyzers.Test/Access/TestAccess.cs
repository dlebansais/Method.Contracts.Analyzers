...
";
    ...
    [Test]
    public async Task TestNoModifierNoLeadingTrivia()
    {
        // The source code to test
        const string Source = @"
namespace Contracts.TestSuite;
...
internal partial class Program
{
    ...
    [Access(""public"")]void HelloFromVerified(string text, out string textPlus)
    {
        textPlus = text + ""!"";
    }
}
...
";
    ...
    [Test]
    public async Task TestCommandOutExpressionBody()
    {
        // The source code to test
        const string Source = @"
namespace Contracts.TestSuite;
...
internal partial class Program
{
    ...
    [Access(""public"", ""static"")]
    private static void HelloFromVerified(string text, out string textPlus) => textPlus = text + ""!"";
}
";
    ...
    [Test]
    public async Task TestQueryExpressionBody()
    {
        // The source code to test
        const string Source = @"
namespace Contracts.TestSuite;
...
internal partial class Program
{
    ...
    [Access(""public"", ""static"")]
    private static string HelloFromVerified(string text) => text + ""!"";
}
";
    ...
    [Test]
    public async Task TestMultilineModifiers()
    {
        // The source code to test
        const string Source = @"
namespace Contracts.TestSuite;
...
";
    ...
    [Test]
    public async Task TestNoContractUsing()
    {
        // The source code to test
        const string Source = @"
namespace Contracts.TestSuite;
