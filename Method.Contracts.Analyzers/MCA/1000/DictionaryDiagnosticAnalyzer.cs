...
/// <summary>
/// Analyzer rules about dictionaries.
/// </summary>
public abstract class DictionaryDiagnosticAnalyzer : DiagnosticAnalyzer
{
    /// <summary>
    ...
    /// <param name="objectCreationExpression">The expression node.</param>
